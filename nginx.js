...
(function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
    ...
    },{"@babel/polyfill":2,"@hapi/accept":310}],2:[function(require,module,exports){
    "use strict";
    ...
    internals.parse = function (raw, preferences, options) {
        ...
        var preferred = [];
        for (var selection of values) {
            if (selection === '*') {
                for (var [preference, value] of lowers) {
    ...
    },{"@hapi/boom":312,"@hapi/hoek":327}],310:[function(require,module,exports){
    'use strict';
    ...
    },{"./header":309,"./media":311}],311:[function(require,module,exports){
    'use strict';
    ...
    internals.parse = function (raw, preferences) {
        ...
        var { header, quoted } = internals.normalize(raw);
    ...
    internals.preferences = function (map, selections, preferences) {
        ...
        for (var selection of selections) {
            ...
            var { type, subtype } = map[token];
            var subtypes = lowers[type];
    
            // */*
    
            if (type === '*') {
                for (var preference of Object.keys(flat)) {
                    if (!map[preference]) {
            ...
            if (subtypes) {
                for (var psub of Object.keys(subtypes)) {
                    if (!map[`${type}/${psub}`]) {
    ...
    },{"@hapi/boom":312,"@hapi/hoek":327}],312:[function(require,module,exports){
    'use strict';
    ...
    exports.Boom = class extends Error {
        ...
        constructor(message, options = {}) {
            ...
            var { statusCode = 500, data = null, ctor = exports.Boom } = options;
    ...
    exports.unauthorized = function (message, scheme, attributes) {          // Or (message, wwwAuthenticate[])
        ...
        var err = new exports.Boom(message, { statusCode: 401, ctor: exports.unauthorized });
    ...
    exports.methodNotAllowed = function (message, data, allow) {
        ...
        var err = new exports.Boom(message, { statusCode: 405, data, ctor: exports.methodNotAllowed });
    ...
    },{"@hapi/hoek":327}],313:[function(require,module,exports){
    'use strict';
    ...
    },{"./assert":314,"./clone":317,"./merge":330,"./reach":332}],314:[function(require,module,exports){
    'use strict';
    ...
    },{"./error":320}],315:[function(require,module,exports){
    ...
    },{"_process":341}],316:[function(require,module,exports){
    'use strict';
    ...
    },{"./ignore":326}],317:[function(require,module,exports){
    ...
    },{"./reach":332,"./types":335,"./utils":336,"buffer":339}],318:[function(require,module,exports){
    'use strict';
    ...
    internals.array = function (ref, values, options) {
        ...
        for (var value of values) {
            if (!options.deep ||
                ...
                var found = false;
                for (var [key, existing] of map.entries()) {
    ...
    },{"./assert":314,"./deepEqual":319,"./escapeRegex":324,"./utils":336}],319:[function(require,module,exports){
    (function (Buffer){(function (){
    'use strict';
    ...
    internals.isSetSimpleEqual = function (obj, ref) {
        ...
        for (var entry of Set.prototype.values.call(obj)) {
    ...
    internals.isDeepEqualObj = function (instanceType, obj, ref, options, seen) {
        ...
        var { isDeepEqual, valueOf, hasOwnEnumerableProperty } = internals;
        var { keys, getOwnPropertySymbols } = Object;
        ...
        if (instanceType === Types.array) {
            if (options.part) {
                ...
                for (var objValue of obj) {
                    for (var refValue of ref) {
            ...
            if (!internals.isSetSimpleEqual(obj, ref)) {
                ...
                for (var objEntry of Set.prototype.values.call(obj)) {
                    if (ref2.delete(objEntry)) {
                        continue;
                    }
    
                    var found = false;
                    for (var refEntry of ref2) {
            ...
            for (var [key, value] of Map.prototype.entries.call(obj)) {
    ...
    },{"./types":335,"buffer":339}],320:[function(require,module,exports){
    'use strict';
    ...
    },{"./stringify":334}],321:[function(require,module,exports){
    'use strict';
    ...
    },{"./assert":314}],322:[function(require,module,exports){
    'use strict';
    ...
    },{"./applyToDefaults":313,"./assert":314,"./bench":315,"./block":316,"./clone":317,"./contain":318,"./deepEqual":319,"./error":320,"./escapeHeaderAttribute":321,"./escapeHtml":322,"./escapeJson":323,"./escapeRegex":324,"./flatten":325,"./ignore":326,"./intersect":328,"./isPromise":329,"./merge":330,"./once":331,"./reach":332,"./reachTemplate":333,"./stringify":334,"./wait":337}],328:[function(require,module,exports){
    'use strict';
    ...
    },{"./assert":314,"./clone":317,"./utils":336,"buffer":339}],331:[function(require,module,exports){
    'use strict';
    ...
    },{"./assert":314}],333:[function(require,module,exports){
    'use strict';
    ...
    },{"./reach":332}],334:[function(require,module,exports){
    'use strict';
    ...
    },{"buffer":339}],336:[function(require,module,exports){
    'use strict';
    ...
    },{"base64-js":338,"buffer":339,"ieee754":340}],340:[function(require,module,exports){
